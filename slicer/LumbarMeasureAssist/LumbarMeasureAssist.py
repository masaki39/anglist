...
class LumbarMeasureAssist(ScriptedLoadableModule):
    """Main module class required by Slicer."""

    def __init__(self, parent=None):
        ScriptedLoadableModule.__init__(self, parent)
        self.parent.title = "Lumbar Measure Assist"
...
class LumbarMeasureAssistWidget(ScriptedLoadableModuleWidget):
    """Widget setup and interactions."""

    def setup(self):
        ScriptedLoadableModuleWidget.setup(self)

        self.logic = LumbarMeasureAssistLogic()
...
class LumbarMeasureAssistLogic(ScriptedLoadableModuleLogic):
...
class LumbarMeasureAssistTest(ScriptedLoadableModuleTest):
    ...
    def test_compute_angles_simple_geometry(self):
        ...
        """
        logic = LumbarMeasureAssistLogic()
        points = {
            "FH": (0.5, 2.0),
            "S1_ant": (0.0, 0.0),
            "S1_post": (1.0, 1.0),
